    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input type="text" id="college" value={formData.college} onChange={handleChange} required />
        </div>
        <div>
        ...
        <div>
          <label>Contact</label>
          <input type="text" id="contact" pattern="[6789][0-9]{9}" value={formData.contact} onChange={handleChange} required />
        </div>
